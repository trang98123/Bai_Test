...
public static final String DISPLAY_ORDER_TEXTBOX_UP_DOW="//input[@id='AddPictureModel_DisplayOrder']/following-sibling::span/span[@aria-label='%s value']";
...
public static final String OK_BUTTON="//div[@id='addProductPictureAlert-action-alert']//div[@class='modal-dialog']//div[@class='modal-footer']//span[@class='btn btn-primary float-right' and text()='Ok']";
